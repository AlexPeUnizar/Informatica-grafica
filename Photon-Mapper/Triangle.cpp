...
/**
 * @brief Aplica una transformacion matricial al triángulo.
 * 
 * Este metodo transforma las posiciones de los vertices del triángulo utilizando la matriz de transformacion proporcionada.
 * Si el triángulo tiene normales por vértice, estas también se transforman y normalizan.
 * 
