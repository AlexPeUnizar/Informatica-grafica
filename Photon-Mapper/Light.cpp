 ...
 * 
 * Este archivo contiene la definicion de los métodos de la clase Light, que representa una fuente de luz
...
/**
 * @brief Calcula la intensidad promedio de la fuente de luz.
 * 
 * Este método calcula la intensidad de la luz como el promedio de sus componentes RGB.
 * 
 * @return Intensidad promedio de la luz.
 */
