/**
 * @file Plane.hpp
 * @brief Declaracion de la clase Plane para la representacion de planos en el sistema de gráficos.
 * 
 ...
 * Hereda de la clase Figure e incluye metodos para la interseccion con rayos y la gestion de materiales asociados.
 * 
 * @author Alex
 * @date 18-6-2025
 */
 ...
 * Permite verificar si un rayo intersecta con el plano y proporciona informacion sobre la interseccion.
 * 
 * @see Figure
 */
